...
// myfiles.txt is the js code. I also added a new PHP file called myfilesDownloaded and made a new MySQL table called downloads
//  5 Attachments
//   •  Scanned by Gmail
// Awesome, thanks!Thanks, I'll check it out!Fixed!
// window.addEventListener("load", async function (event) {
//   //   <div class="file-card">
//   //   <button class="btn btn-primary view-btn">View</button>
//   // </div>
...
//   function displayDownloadedFiles(rows) {
//     let downloaded_files_display = document.querySelector("#downloadedFiles .files-list");
  
//     downloaded_files_display.innerHTML = "No Files Found :/ "; // Clear existing content
//     console.log(rows);
//     if (rows.length === 0 || rows == null || rows == false) {
//       console.log("No uploaded files");
//     }
//     else{
//       downloaded_files_display.innerHTML = "";
//       for (let row of rows) {
//         let file_card = document.createElement("div");
//         file_card.classList.add("file-card");
//         file_card.setAttribute("data-name", row.filetitle); // for search filtering
    
//         let h3_file_title = document.createElement("h3");
//         h3_file_title.textContent = row.filetitle;
    
//         let download_button = document.createElement("button");
//         download_button.classList.add("btn", "btn-primary", "download-again-btn");
//         download_button.innerHTML = `<i class="ri-download-2-line"></i> Download Again`;
...
//           newFromData.append("filename", row.filename);
...
//         file_card.appendChild(h3_file_title);
//         file_card.appendChild(download_button);
    
//         downloaded_files_display.appendChild(file_card);
//       }
//     }
//   }
...
//   async function submitFormDownloaded(filename) {
//     formData = new FormData();
//     formData.append("query", filename);
//     formData.append("macID", macID);

//     let download_files_plus_macid = (await searchDatabase(formData, "server/myfilesDownloaded.php")).message;
//     displayDownloadedFiles(download_files_plus_macid[0]);
//   }

//   //uploads search inputs
//   document
//     .getElementById("uploadedSearchInput")
//     .addEventListener("input", function (event) {
//       filename = this.value;
...
//   document
//   .getElementById("downloadedSearchInput")
//   .addEventListener("input", function (event) {
//     filename = this.value;
//     submitFormDownloaded(filename);
//   });
